...
export async function POST(req: NextRequest) {
  ...
  console.log("🔥🔥🔥 [API-LEAD-GEN] Headers:", Object.fromEntries(req.headers.entries()))
  ...
  try {
    ...
    console.log("🔥🔥🔥 [API-LEAD-GEN] Calling runFullLeadGenerationWorkflowAction with campaignId:", campaignId)
    ...
    console.error("🔥🔥🔥 [API-LEAD-GEN] Error message:", error instanceof Error ? error.message : String(error))
    console.error("🔥🔥🔥 [API-LEAD-GEN] Error stack:", error instanceof Error ? error.stack : 'No stack')
